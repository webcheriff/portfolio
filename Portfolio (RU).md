...
Чтобы проверить четыре эндпоинта в API 'Яндекс Прилавок', я составил чеклист, используя техники тест-дизайна – классы эквивалентности и граничные значения.
...
> * Если `canсelled == true`, то вывел статус -1.
> * Если `inDelivery == true`, то вывел статус 1.
> * Для остальных случаев вывел 0.

## Пример в виде таблицы

| |Что сделал|Что применил|Почему так|
|-|----|---|--------|
|[Чеклист в Google Docs](https://docs.google.com/spreadsheets/d/1Hc3tJqIDyNmGdxQrubZLAf-fjmpPrXA9Z1Y6-yMejwQ/edit?usp=sharing)|Это список проверок для проекта по тестированию API учебного приложения Яндекс Прилавок.|Чтобы проверить четыре эндпоинта в API 'Яндекс Прилавок' я составил чеклист, используя техники тест-дизайна – классы эквивалентности и граничные значения.|По условиям проекта времени на тестирование мало, поэтому формат тест-кейсов не подходил. А применение техник КЭ и ГЗ позволило провести оптимальное количество проверок.|
|[Ссылка на доску в YouTrack](https://cherrost.youtrack.cloud/)|...|...|...|
